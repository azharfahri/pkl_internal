                        ...
                        <div class="swiper-wrapper">
                            @foreach ($category as $data)
                                <a href="#" class="nav-link category-item swiper-slide">
                                    <img src="{{ asset('user/images/icon-soft-drinks-bottle.png') }}" alt="Category Thumbnail">
                                ...
                                <div class="product-grid row row-cols-1 row-cols-sm-2 row-cols-md-3 row-cols-lg-4 row-cols-xl-5">
                                    ...
                                    <div class="col">
                                        <div class="product-item">
                                            ...
                                            <span class="qty"> stok:{{$data->stok}}</span><span class="rating"><svg width="24" height="24" class="text-primary">
                                            ...
                                            <div class="d-flex align-items-center justify-content-between">
                                                ...
                                                <a href="#" class="btn btn-primary">Add to Cart <iconify-icon icon="uil:shopping-cart"></a>
                                            </div>
                                        </div>
                                    </div>
                                    @endforeach
